...
//         RoleMessage msg = chatPromptTemplate.toMsg(template, paramPayload);
...
//         RoleMessage msg = chatPromptTemplate.toMsg(template, new LLMMemory(Map.of("param", "map声明方式", "name", "姓名", "age", 18, "测试", true, "chatRole", ChatRole.AI)));
//         Assert.equals(ChatRole.AI, msg.role());
//         Object parse = chatPromptTemplate.parse(msg);
//         String result = """
...
//         chatPromptTemplate.setOutputParse(msg->msg.getContent().length());
//         RoleMessage msg = chatPromptTemplate.toMsg(template,new LLMMemory( Map.of("param", "map声明方式", "name", "姓名", "age", 18, "测试", true, "chatRole", ChatRole.AI)));
//         Assert.equals(ChatRole.AI, msg.role());
